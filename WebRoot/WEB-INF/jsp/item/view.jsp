...
<div class="width1198 center_yh" style="height: 420px;border-bottom: 2px solid #dd4545;margin-top: 20px">
    <div class="left_yh" style="width: 350px;height: 420px;">
        <input type="hidden" id="id" value="${obj.id}">
        <div id="preview">
            <div>
                <img src="${obj.url1}" alt=""  style="margin: auto;height: 340px">
            </div>
            <%--<div id=spec-list" style="margin-top: 5px;margin-left: 10px;">
                <ul class="list-h">
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <p class="font16 c_66" style="margin-top:25px;">作者：${obj.autor}</p>
        <p class="font16 c_66" style="margin-top:25px;">出版社：${obj.pub}</p>
        <p class="font16 c_66" style="margin-top:25px;">出版时间：${obj.pubtime}</p>
