    ...
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li style="height: 330px">
                ...
                <p  class="spName" style="font-size: 13px;">
                    <a href="#" style="color:#000;" onmouseover="this.style.color='#ff0000';" onmouseout="this.style.color='#000';">${data.autor}</a>&nbsp;&nbsp;/&nbsp;&nbsp;
                    <a href="#" style="color:#000;" onmouseover="this.style.color='#ff0000';" onmouseout="this.style.color='#000';">${data.pub}</a>&nbsp;&nbsp;/&nbsp;&nbsp;
                        ${data.pubtime}</p>
                <div class="wCa">
