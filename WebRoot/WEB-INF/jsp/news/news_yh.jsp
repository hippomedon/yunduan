        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body" >
                    <form class="layui-form layui-col-space5" action="${ctx}/news/findBySql"  method="post">

                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="name"  placeholder="请输入公告名称" autocomplete="off" class="layui-input"  value="${obj.name}">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加公告','${ctx}/news/add',800,600)"><i class="layui-icon"></i>添加</button>
                </div>
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                            <tr>
                                ...
                                <td class="td-manage">
                                    <a title="编辑" href="javascript:;" onclick="xadmin.open('编辑','${ctx}/news/update?id=${data.id}','800','510','1')"
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            <pg:pager url="${ctx}/news/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="10" export="curPage=pageNumber">
                               <pg:last>
        ...
        layer.confirm('确认要删除吗？',{icon:3,title:'提示信息'},function(index){
            ...
            $.ajax({
                ...
                success:function (data) {
                    console.log("new_yh删除"+data.message);
                }
            });
