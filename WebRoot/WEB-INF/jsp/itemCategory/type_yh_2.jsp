        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加商品','${ctx}/itemCategory/add2?pid=${obj.pid}',800,600)"><i class="layui-icon"></i>添加</button>
                </div>
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                            <tr>
                                ...
                                <td class="td-manage">
                                    <a title="编辑" href="javascript:;" onclick="xadmin.open('编辑','${ctx}/itemCategory/update2?id=${data.id}','800','510','1')"
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            <pg:pager url="${ctx}/itemCategory/findBySql2" maxIndexPages="5" items="${pagers.total}" maxPageItems="10" export="curPage=pageNumber">
                                <pg:param name="pid" value="${obj.pid}"/>   <%--传递pid--%>
                                <pg:last>
   ...
   /* function member_stop(obj,id){
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',{icon:3,title:'提示信息'},function(index){
            ...
            $.ajax({
                type:"POST",
                url:"${ctx}/itemCategory/delete2",
                //data:"id="+id,
                data:{id:id},
                dataType:"json",
                success:function (data) {
                    console.log("type_yh_2删除"+data.message);
                }
            });
