...
<html class="x-admin-sm">
    <head>
      ...
      <%--  <meta name="viewport" content="width=device-width,user-scalable=yes, minimum-scale=0.4, initial-scale=0.8,target-densitydpi=low-dpi" />--%>
        ...
        <script src="${ctx}/resource/static_yh/js/jquery.js"></script>
        <script src="${ctx}/resource/static_yh/js/jquery.min.js"></script>
        <script src="${ctx}/resource/static_yh/js/survey.js"></script>
        <style>
            #FontScroll{
                width: 100%;
                height: 245px;
    ...
    <script src="${ctx}/resource/static_yh/js/echarts.min.js"></script>
    ...
    <script src="${ctx}/resource/static_yh/js/fontscroll.js"></script>
