...
<html class="x-admin-sm">
    <head>
        ...
        <link rel="stylesheet" href="${ctx}/resource/static_yh/css/iconfont.css">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./index.html">云端书城后台管理系统</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;">${sessionScope.manage}</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <%--<dd>
                ...
                <li class="layui-nav-item to-index">
                    <a href="${ctx}/login/uIndex">前台首页</a>
                </li>
            </ul>
        ...
        <div class="left-nav show_list" id="table1">
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        <a href="javascript:;" onclick="xadmin.add_tab('我的桌面','${ctx}/itemCategory/welcome')">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('商品类型','${ctx}/itemCategory/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>商品类型</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('商品列表','${ctx}/item/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>商品列表</cite></a>
                            </li>
                           <%-- <li>
                   ...
                   <%-- <li class="layui-nav-item">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('订单列表','${ctx}/itemOrder/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>订单列表</cite></a>
                            </li>
                            <%--<li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('会员列表','${ctx}/user/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>会员列表</cite></a>
                            </li>
                ...
                <ul id="nav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('公告列表','${ctx}/news/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>公告列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('留言列表','${ctx}/message/findBySql')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>留言列表</cite></a>
                            </li>
                        </ul>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src="${ctx}/itemCategory/welcome" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
...
<div class="copyrights" id="links20210126">
    ...
    <script type="text/javascript" src="${ctx}/resource/static_yh/js/jquery.min.js"></script>
