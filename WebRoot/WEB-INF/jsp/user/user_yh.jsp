        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body" >
                    <form class="layui-form layui-col-space5" action="${ctx}/user/findBySql"  method="post">

                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="userName"  placeholder="请输入用户名" autocomplete="off" class="layui-input"  value="${obj.userName}">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                            <tr>
                                ...
                                <td class="td-manage">
                                    <i class="layui-icon" style="color: red">ဆ</i>（不可操作）每个搜索都不会分页，大体完成搞
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            <pg:pager url="${ctx}/user/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="10" export="curPage=pageNumber">
                               <pg:last>
