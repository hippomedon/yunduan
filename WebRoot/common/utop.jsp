...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        <font class="left_yh">云端图书--欢迎您！</font>
...
<div class="width100 hidden_yh">
    <div class="width1200 center_yh hidden_yh" style="margin-top: 10px;">
        <a href="${ctx}/login/uIndex" class="block_yh left_yh">
            <img src="${ctx}/resource/images_yh/taobao.png" alt="" style="height: 70px">
        </a>

        <div class="" style="height:28px;width:316px;border:2px solid #dd4545; margin:20px auto">
            <form action="${ctx}/item/shoplist" method="post">
                <input type="text" placeholder="健康生活每一天！" class="search" name="condition" value="${condition}">
