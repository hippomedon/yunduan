...
public class ItemController extends BaseController {
    ...
    @ResponseBody
    public R exAdd(Item item, @RequestParam("file")CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
    ...
    @ResponseBody
    public R exUpdate(Item item, @RequestParam("file") CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
    ...
    private void itemCommon(Item item, @RequestParam("file") CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
        ...
        if(files.length>0) {
            for (int s = 0; s < files.length; s++) {
                ...
                System.out.println("图片"+files[s].getOriginalFilename());
        ...
        System.out.println("===>"+byId.getPid());
